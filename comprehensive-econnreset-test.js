...
// Create a comprehensive test file with various types of emails
const testEmails = [
...
// Create JSON file for comprehensive ECONNRESET handling test
const bulkData = {
  emails: testEmails,
  options: {
...
fs.writeFileSync('comprehensive-econnreset-test-bulk.json', JSON.stringify(bulkData, null, 2));

console.log(`Generated ${testEmails.length} test emails for comprehensive ECONNRESET testing.`);
console.log('File created: comprehensive-econnreset-test-bulk.json');
console.log('\nTo test the ECONNRESET handling:');
console.log('1. Run: curl -X POST http://localhost:3000/v1/validate/bulk -H "Content-Type: application/json" -d @comprehensive-econnreset-test-bulk.json');
